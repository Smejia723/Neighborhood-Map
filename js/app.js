...
/*
    var oldQuebec = {lat: 46.8122, lng: -71.2065}
    var marker = new google.maps.Marker({
      position: oldQuebec,
      map: map,
      title: 'Old Quebec'
    ...
    var infowindow = new google.maps.InfoWindow({
        content: 'Old Quebec is a historic neighbourhood of Quebec City,'+
        ' Quebec, Canada. Comprising the Upper Town and Lower Town,'+
    ...
    var citadelleOfQuebec = {lat: 46.8078, lng: -71.2069}
    var marker = new google.maps.Marker({
      position: citadelleOfQuebec,
      map: map,
